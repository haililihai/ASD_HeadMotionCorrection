function BF_PlotQuantiles(xData,yData,numThresholds,alsoScatter,makeNewFigure,theColor,theMarker)
...
for k = 1:numThresholds-1
    ...
    plot(mean(xThresholds(k:k+1)),yMeans(k),theMarker,'MarkerSize',5,'LineStyle',theStyle,'LineWidth',lineWidth,'Color',[theColor])
end
